...
def run_metadata(args, dataset, problem_ids):
    return {
        ...
        "frontier_v2_min_refinement_gain_observations": args.frontier_v2_min_refinement_gain_observations,
...
def run_dataset(args, dataset, problem_ids):
    ...
    if args.resume and results_complete(result_path, metadata_path, metadata):
        ...
        command = [
            ...
            "--frontier_v2_min_refinement_gain_observations", str(args.frontier_v2_min_refinement_gain_observations),
            "--seed", str(args.seed),
            "--quiet_generation",
            "--disable_progress",
            "--skip_artifacts",
